...
def _avoid_board(my_head: Dict[str, int], board: Dict[str, int], possible_moves: List[str]) -> List[str]:
    """
...
def _avoid_my_body(my_head: Dict[str, int], my_body: List[dict], possible_moves: List[str]) -> List[str]:
    """
...
def _avoid_others(my_head: Dict[str, int], others: List[dict], possible_moves: List[str]) -> List[str]:
  """
...
def _move_to_target(my_head: Dict[str, int], target: Dict[str, int], possible_moves: List[str]) -> str:
  if bool(target):
